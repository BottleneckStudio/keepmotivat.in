...
<html lang="en-gb" dir="ltr">
    ...
    <head>
        ...
        <title>Smooth scroll component - UIkit documentation</title>
    ...
    <body class="tm-background">
        ...
        <nav id="top" class="tm-navbar uk-navbar uk-navbar-attached">
                ...
                <div class="uk-grid" data-uk-grid-margin>
                    <div class="tm-sidebar uk-width-medium-1-4 uk-hidden-small">
                        ...
                        <ul class="tm-nav uk-nav" data-uk-nav>
                            ...
                            <li class="uk-active"><a href="smooth-scroll.html">Smooth scroll</a></li>
                    ...
                    <div class="tm-main uk-width-medium-3-4">
                        ...
                        <article class="uk-article">
                            ...
                            <h1 id="bottom" class="uk-article-title">Smooth scroll</h1>

                            <p class="uk-article-lead">Enhance your site with a nice effect that slows down the scrolling when jumping to another part of your page.</p>

                            <h2 id="usage"><a href="#usage" class="uk-link-reset">Usage</a></h2>

                            <p>To gradually descrease the speed when you jump from one section of your page to another, for example with a to-top scroller, just add the <code>data-uk-smooth-scroll</code> attribute to an <code>&lt;a&gt;</code> element, that links to the ID of the section you want to target.</p>

                            <h3 class="tm-article-subtitle">Example</h3>

                            <p>In our example we are using the heading <em>Smooth scroll</em> as target.</p>

                            <a href="#top" class="uk-button" data-uk-smooth-scroll>Go Up!</a>

                            <a href="#bottom" class="uk-button" data-uk-smooth-scroll>Go Down!</a>

                            <h3 class="tm-article-subtitle">Markup</h3>

<pre><code>&lt;a href="#my-id" class="uk-button" data-uk-smooth-scroll>...&lt;/a&gt;</code></pre>


                            <hr class="uk-article-divider">


                            <h2 id="offset"><a href="#offset" class="uk-link-reset">Offset</a></h2>
                            ...
                            <div class="uk-overflow-container">
                                <table class="uk-table uk-text-nowrap">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><code>data-uk-smooth-scroll="{offset: 90}"</code></td>
                            ...
                            <p><a href="#bottom" data-uk-smooth-scroll="{offset: 90}">This link</a> scrolls the site to the headline &quot;Smooth scroll&quot; with an offset of <code>90px</code>.</p>

                            <p><a href="#bottom" data-uk-smooth-scroll="{offset: -90}">This link</a> scrolls the site to the headline &quot;Smooth scroll&quot; with an offset of <code>-90px</code>.</p>

                            <h3 class="tm-article-subtitle">Markup</h3>

<pre><code>&lt;a href="#my-id" data-uk-smooth-scroll="{offset: 90}">...&lt;/a&gt;

&lt;a href="#my-id" data-uk-smooth-scroll="{offset: -90}">...&lt;/a&gt;</code></pre>

                            <hr class="uk-article-divider">

                            <h2 id="javascript"><a href="#javascript" class="uk-link-reset">JavaScript</a></h2>

                            <p>You can manually trigger a smooth scroll animation to a any target element on your site using javascript.</p>

                            <h3 class="tm-article-subtitle">Smooth scroll to a target element</h3>

                            <pre><code class="javascript">UIkit.Utils.scrollToElement(UIkit.$(element, { <span class="comment">/* options */</span> });</code></pre>
                            ...
                            <div class="uk-overflow-container">
                                <table class="uk-table uk-table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td>integer</td>
                                        <td>1000</td>
                                        <td>Allows to determine how long the scroll animation will run</td>
                                    </tr>
                                    <tr>
                                        <td><code>offset</code></td>
                                        <td>integer</td>
                                        <td>0</td>
                                        <td>Adds a specified distance to the target elment when calculating the scroll position</td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
